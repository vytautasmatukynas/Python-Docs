...
def uzsakymai():
    ...
    # Column list names
    my_tree['columns'] = ("IMONE", "KONSTRUKTORIUS", "PROJEKTAS", "TERMINAS", "STATUSAS", "ID")

    # Column size
    my_tree.column("#0", width=0, stretch=NO)
    my_tree.column("IMONE", anchor=W, width=100)
    my_tree.column("KONSTRUKTORIUS", anchor=W, width=100)
    ...
    my_tree.heading("KONSTRUKTORIUS", text="KONSTRUKTORIUS", anchor=W)
    ...
    def new_record():
        ...
        vt = Label(data_frame, text="KONSTRUKTORIUS", relief=RAISED, bd=3, font='sans 10', bg='lightyellow', width=15,
                   height=2)
        ...
        def add_record():
            ...
            c.execute("""INSERT INTO uzsakymai VALUES (:imone, :konstruktorius, :projektas, 
    ...
    def update_record_double(e):
        ...
        vt = Label(data_frame, text="KONSTRUKTORIUS", font='sans 10', relief=RAISED, bd=3, bg='lightyellow', height=2)
        ...
        km1_box['values'] = ('GAMINA', 'TAISO BROKA', 'VELUOJA', 'PAGAMINTA')
...
button1 = Button(mainWindow, text='UZSAKYMAI', relief=RAISED, bd=3, bg='silver', command=uzsakymai,
                 font='sans 16 bold', width=5, height=5)
button1.grid(column=0, row=0, sticky='nsew')

button2 = Button(mainWindow, text='', relief=RAISED, bd=3, bg='silver',
                 font='sans 16 bold', width=5, height=5)
button2.grid(column=1, row=0, sticky='nsew')

button3 = Button(mainWindow, text='', relief=RAISED, bd=3, bg='silver',
                 font='sans 16 bold', width=5, height=5)
...
file_menu.add_command(label="Uzsakymai", command=uzsakymai)
