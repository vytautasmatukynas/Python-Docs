...
stelazas_db_table = db_conn.stelazas_db

class MainWindowStelazas(object):
    def setupUi(self, MainWindow):
        MainWindow.setObjectName("SANDELIO ZONOS")
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("SANDELIO ZONOS", "SANDELIO ZONOS"))
